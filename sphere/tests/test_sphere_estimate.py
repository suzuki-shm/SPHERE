...
class SphereEstimateTest(unittest.TestCase):
    ...
    def test_sphere_estimate_command_sampling_elc_single(self):
        argv_str = """{0} {1} -m explinearcardioid -sc 1 -si 30 -sw 20
                      -ff""".format(
            self.__output,
            self.__input[0],
            self.__output_fit,
    ...
    def test_sphere_estimate_command_optimizing_elc_single(self):
        argv_str = """{0} {1} -M optimizing -m explinearcardioid
                      -ff""".format(
            self.__output,
            self.__input[0],
        )
